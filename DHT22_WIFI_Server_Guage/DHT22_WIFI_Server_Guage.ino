    ...
    while (client.connected()) 
    {
          if (client.available()) 
          {
                ...
                if (c == '\n' && currentLineIsBlank) 
                {
                      ...
                      client.println(h);
                      client.println("],]);");
                      client.println(" var options = {width: 600, height: 600,redFrom: 90, redTo: 100,yellowFrom:75, yellowTo: 90,minorTicks: 5};");
                      ...
                      client.println("</head>");
                      client.println("<body>");
                      client.println("<div id='chart_div' style='width: 600px; height: 600px;'></div>");
                      client.println("</body>");                                            
                       /*
